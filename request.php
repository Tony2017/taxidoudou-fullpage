...
<section id="fullpage">
    <div class="section" id="section1">
        <div class="col-md-offset-1 col-md-11 titles-container">
            <div class="container">
                <div class="map-infos">
                    <span class="flaticon-gps flaticon" id="map" style="opacity: 0.5"></span>
                    <div class="map-location">
                        <div class="pos-text"><p>De</p></div>
                        <div class="map-from pos-line"><input type="text" name="from" value="<?php echo $start_latlng["start_formatted_address"] ?>" readonly></div>
                        <div class="pos-text"><p>A</p></div>
                        <div class="map-to pos-line"><input type="text" name="to" value="<?php echo $end_latlng["end_formatted_address"] ?>" readonly></div>
                        <div class="pos-text"><p>Km</p></div>
                        <div class="map-to pos-line"><input type="text" name="to" id="km" value="<?php echo $race->getDistanceKm() ?>" readonly></div>
                        <div class="pos-text"><p>Prix</p></div>
                        <div class="map-to pos-line"><input type="text" name="to" value="<?php echo $race->getPriceCourse(); ?>" readonly></div>
                    </div>
                </div>
