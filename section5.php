<div class="section fp-auto-height" id="section5">
    ...
    <div class="contact">
        <div id="map-local" style="opacity: 0.8"></div>
        <div class="container">
            ...
            <div class="address col-md-4 col-sm-12">
                ...
                <div class="address-info">
                    <div class="flaticon-location-pin footer-icon"></div>
                    <p>Cité de la Rosière 1</p>, <p>1470 Estavayer-le-Lac</p>
                </div>
                <div class="address-info">
                    <div class="flaticon-phone-receiver footer-icon"></div>
                    <p>079 846 29 84</p>
                </div>
                <div class="address-info">
                    <div class="flaticon-envelope footer-icon"></div>
                    <p>contact@taxidoudou.ch</p>
                </div>
                <div class="address-info">
                    <div class="flaticon-facebook-logo footer-icon"></div>
                    <p><a href="https://www.facebook.com/taxidoudou/" rel="nofollow">Taxidoudou</a></p>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="padding-right: 0px;">
                            ...
                            <div class="input-group col-md-12 col-sm-12 col-xs-12" id="input_position">
                                <input type="text" class="form-control" id="nom_prenom" placeholder="Nom & Prénom">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-inline col-md-12 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="padding-right: 0px;">
                            ...
                            <div class="input-group col-md-12 col-sm-12 col-xs-12">
                                <textarea class="form-control custom-control" id="message" rows="4" style="resize:none"
                                          placeholder="Message"></textarea>
                                <span class="input-group-addon btn send-btn" id="envoyer">Envoyer</span>
                            </div>
                        </div>
                    </div>
                </div>
